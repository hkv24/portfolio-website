...
let email = 'harshkumarverma99@gmail.com';
let phone = '+91 8178936792';
    ...
    <Container id="contact">
      <div className="flex flex-col items-center gap-4">
        ...
        <Typography variant="subtitle" className="max-w-xl text-center">
          Looking to collaborate or have a question? Feel free to reach out—whether
          you need a developer, seek technical insights, or just want to connect.
        </Typography>
      </div>

      <div className="flex flex-col items-center gap-6 md:gap-12">
        <div className="flex flex-col items-center text-sm sm:text-base md:gap-4">
